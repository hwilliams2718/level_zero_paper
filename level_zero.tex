...
\saySS{I renamed the $\bfc$- and $\bfg$-vectors to have uniform notation with section 3.1. There there are plenty of $c$'s floating around and it is probably sligthly better try to distinguish them. This notation emphasize that we are dealing with roots and weights even if it is not stated here yet.}

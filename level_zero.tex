...
\subsection{Affine Tubes}
  ...
  \end{equation}
  This also gives a labeling of the generators of $\overrightarrow{\rep}Q$ and $\overleftarrow{\rep}Q$ respectively as $\vec{M}_{1,\ell}$ for $1\le\ell\le p$ and $\cev{M}_{1,\ell}$ for $1\le\ell\le q$.  The indices of these representations can be described as follows:
  \begin{equation}

...
\subsection{Affine Tubes}
  ...
  Let $\sigma\in\Sigma_{n+1}$ denote a permutation of the vertices of $Q$ such that $\sigma_0$ is a sink in $Q$ and $\sigma_i$ is a sink in $\mu_{i-1}\cdots\mu_0 Q$ for $1\le i\le n$.  Let $c=s_{\sigma_n}\cdots s_{\sigma_0}$ denote the Coxeter element adapted to $Q$.
  \erase{%begin erase
  \begin{theorem}

...
In view of how simple reflections act on fundamental weights the expressions of the $\bfg$-vectors $\lambda_{m,i}$ can be further simplified as follows:
\begin{equation}
  \lambda_{m,i}
  =
  \begin{cases}
  ...
  \end{cases}
\end{equation}
In particular, in the acyclic belt of $\cAb(B_c)$, there is one cluster variable $x_{c^k\omega_i}$ with  $\bfg$-vector $c^k\omega_i$ $(k\geq 0)$ and one cluster variable $x_{-c^{-k}\omega_i}$ with $\bfg$-vector $-c^{-k}\omega_i$ $(k\geq 0)$.

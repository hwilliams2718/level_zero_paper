...
\begin{proposition}
  ...
  \begin{equation}
    ...
    \begin{cases}
      ...
      -c^{1+\left\lfloor\frac{m+1}{n}\right\rfloor}s_n\cdots s_{\mod{m+1}} \alpha_i & \text{if $m <-n$}\\
    \end{cases}
  \end{equation}
...
\begin{remark}
  ...
  Similarly, if $m<-n$, $c^{1+\left\lfloor\frac{m+1}{n}\right\rfloor}s_n\cdots s_{\mod{m+1}}$ is the prefix of $c^{-\infty}$ of length $-m-n$.
\end{remark}
...
\begin{proof}
  ...
  Similarly, when $m<-n$ the root $-c^{1+\left\lfloor\frac{m+1}{n}\right\rfloor}s_n\cdots s_{\mod{m+1}} \alpha_{\mod{m+1}}$ is positive and the root $-c^{1+\left\lfloor\frac{m+1}{n}\right\rfloor}s_n\cdots s_{\mod{m+1}} \alpha_{\mod{m}}$ is negative.
...
\begin{proposition}
  ...
  \begin{equation}
    ...
    \begin{cases}
      ...
      -c^{1+\left\lfloor\frac{m+1}{n}\right\rfloor}s_n\cdots s_{\mod{m+1}} \omega_i & \text{if $m <-n$}\\
    \end{cases}
  \end{equation}
\end{proposition}
...
\begin{equation}
  ...
  \begin{cases}
    ...
    \omega_i & \text{if $-n\leq m \leq 0$ and  $i\leq n+m$} \\
    -\omega_i & \text{if $-n\leq m \leq 0$ and $i>n+m$} \\
    -c^{1+\left\lfloor\frac{m+1}{n}\right\rfloor} \omega_i & \text{if $m <-n$ and $i < \mod{m+1}$}\\
    -c^{\left\lfloor\frac{m+1}{n}\right\rfloor} \omega_i & \text{if $m <-n$ and $i \geq \mod{m+1}$}\\
  \end{cases}
\end{equation}
